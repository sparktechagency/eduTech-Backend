...
const getCategoryForPROVIDER = catchAsync(async (req: Request, res: Response) => {

    const result = await CategoryService.getCategoryForPROVIDERFromDB(req.user)

    sendResponse(res, {
        success: true,
        statusCode: StatusCodes.OK,
        message: 'PROVIDER category successfully',
        data: result
    })
})
